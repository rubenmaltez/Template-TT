...
sesiones de Claude Code. Si estás abriendo este repo, leé esto primero.
...
| 2 | **`CLAUDE.md`** (este) | Reglas, invariantes, proceso | Solo si cambia una regla/proceso |
...
este CLAUDE.md → `ARQUITECTURA.md` §0 (¿hay receta para este cambio?).
